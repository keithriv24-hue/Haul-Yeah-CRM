...
- **Phase 3 (NEXT)**: Gmail inboxes via Google OAuth (contact@ = owner+marketing+sales; keithrivera@ = owner ONLY; read/reply/archive/mark unread/search; two-pane). User has NO creds yet → build connect flow + Settings + written instructions (Google Cloud project, Gmail API, OAuth client ID/secret).
